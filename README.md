...
VITE_ELEVENLABS_CONNECTION_TYPE=websocket
```
...
| `VITE_ELEVENLABS_CONNECTION_TYPE` | No | Defaults to `websocket` for demo reliability; set `webrtc` only if your browser and network support LiveKit/WebRTC reliably. |
